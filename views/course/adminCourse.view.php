      ...
      <tbody>
        <?php foreach ($courses as $course) : ?>
          <tr>
            ...
            <td><img src="assets/images/course<?= $course['img'] ?>" alt="" width="60px" class="rounded-circle"></td>
            <td><?= $course['title'] ?></td>
            <td><?= $course['username'] ?></td>
            <td><?= $course['cateName'] ?></td>
            <td><a href="controllers/course/deleteCourse.controller.php?id=<?= $course['course_id'] ?>" style="color: black;"><i class="fa fa-trash" style="color:red;"></i></a>
